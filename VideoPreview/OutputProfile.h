...
enum
{
    OUTPUT_IMAGE_WIDTH_BY_ORIGINAL_FRAME_WIDTH,
...
enum
{
    TIMESTAMP_TYPE_DISABLED, //don`t write timestamp
    TIMESTAMP_TYPE_TOP_LEFT,
    TIMESTAMP_TYPE_TOP_CENTER,
    TIMESTAMP_TYPE_TOP_RIGHT,
    TIMESTAMP_TYPE_BOTTOM_LEFT,
    TIMESTAMP_TYPE_BOTTOM_CENTER,
    TIMESTAMP_TYPE_BOTTOM_RIGHT,
