...
//default source file types
//TODO: enum all video file extensions
LPCTSTR const DEFAULT_SOURCE_FILE_TYPES = 
    _T("mp4;m4v;mp4v;mpv4;hdmov;mov;3gp;3gpp;3g2;3gp2;flv;f4v;")
...
public:
    ...
    CString GetString();
    bool GetFilterString(LPTSTR filter_string, UINT size); //for add files dialog
